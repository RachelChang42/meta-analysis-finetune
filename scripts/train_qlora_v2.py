...
TRAIN_FILE = "/root/autodl-tmp/NLP_Project/data/folds/train_chunk_fold_3_noref.jsonl"
OUTPUT_DIR = "/root/autodl-tmp/NLP_Project/outputs/qwen25_7b_lora_fold3_v3_reduced"
...
training_args = TrainingArguments(
    ...
    learning_rate=5e-5,  # 由2e-4改为5e-5
